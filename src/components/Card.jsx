  ...
  return (
    <div className="bg-white/50 backdrop-blur-md border border-white/20 rounded-2xl shadow-md hover:shadow-xl transition transform hover:scale-105 overflow-hidden">
      <figure className="relative">
        <LazyLoadGameImage image={game.background_image} alt={game.name} className="h-48 w-full object-cover" />
      ...
      <div className="p-4">
        ...
        <div className="flex justify-end">
          <button className="bg-yellow-300 hover:bg-yellow-400 text-black text-sm px-3 py-1 rounded shadow">
            Details
          </button>
        </div>
      </div>
