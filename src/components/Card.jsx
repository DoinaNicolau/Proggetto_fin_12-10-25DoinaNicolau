...
import RatingInput from "./RatingInput"; // 1. IMPORTIAMO IL NUOVO COMPONENTE
...
export default function Card({ game }) {
  ...
  const renderStars = (rating) => {
    ...
    for (let i = 0; i < fullStars; i++) {
      stars.push(
        // Sostituito text-accent con text-red-600
  ...
  return (
    // Sostituito hover:border-accent con hover:border-red-600
    <div className="bg-gray-800 rounded-lg overflow-hidden group transition-transform duration-500 ease-in-out hover:-translate-y-2 flex flex-col justify-between border border-gray-700/50 hover:border-red-600">
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        {/* 2. AGGIUNGIAMO IL COMPONENTE DI VOTAZIONE QUI */}
        <div className="mb-4">
